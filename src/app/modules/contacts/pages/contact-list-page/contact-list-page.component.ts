...
export class ContactListPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.displayedColumns = [
      { title: 'CONTACTS.FULLNAME', action: false, reference: 'fullName',activePipe:true,namePipe:['titlecase'], activeSearch:true,sizeWidth:'w-150' },
      ...
      { title: 'CONTACTS.ORGANIZATION', action: false, reference: 'organization',activePipe:true,namePipe:['titlecase'], activeSearch:true,sizeWidth:'w-150' },
      { title: 'CONTACTS.LEVEL1', action: false, reference: 'level1',activePipe:true,namePipe:['titlecase'], activeSearch:true,sizeWidth:'w-150' },
      { title: 'CONTACTS.LEVEL2', action: false, reference: 'level2',activePipe:true,namePipe:['titlecase'], activeSearch:true,sizeWidth:'w-150' },
      { title: 'CONTACTS.LEVEL3', action: false, reference: 'level3',activePipe:true,namePipe:['titlecase'], activeSearch:true,sizeWidth:'w-150' },
