...
import { EmailModel } from '@core/models/emails.model';
import { RestService } from '@core/services/rest.service';
import { CookieService } from 'ngx-cookie-service';
import { routeEnpoints } from 'src/app/global/endpoints';

@Component({
  selector: 'app-dialog-form-email',
  templateUrl: './dialog-form-email.component.html',
  styleUrls: ['./dialog-form-email.component.scss']
})
export class DialogFormEmailComponent implements OnInit {
  public modulesQuill = {
    toolbar: [
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: { id: string, toggle: true, serviceName: string, idContact: string }, public dialogRef: MatDialogRef<DialogFormEmailComponent>,
